...
DockStyles::DockStyles(QWidget *main_window) : QFrame(main_window)
{
    ...
    stylesLayout->addWidget(addHSeparator(),1,0,1,4);
    ...
    stylesLayout->addWidget(addHSeparator(),4,0,1,2);
    ...
    stylesLayout->addWidget(addHSeparator(),8,0,1,2);
...
*/
QString DockStyles::getInfoTextLocation() {

        return QString::number(infoTextLocationComboBox->currentIndex()+1);
}
...
*@return QString - Index de la position séléctionnée.
*/
QString DockStyles::getTimeStampLocation()
{
    return QString::number(timestampLocationComboBox->currentIndex()+1);
}
...
*/
QString DockStyles::getSizeInfoText()
{
    return QString::number(infoTextSizeSpinBox->value());
}
...
*@return QString - Taille de la police séléctionnée. Range: [6-72].
*/
QString DockStyles::getSizeTimeStamp()
{
    return QString::number(timestampSizeSpinBox->value());
}
