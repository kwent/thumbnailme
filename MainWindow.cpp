...
void MainWindow::initializeActions()
{
    ...
    aboutQtAction = aboutMenu->addAction(QIcon( ( ":/qt-project.org/qmessagebox/images/qtlogo-64.png" ) ),QString() );
...
void MainWindow::aboutThumbnailme()
{
    About *aboutWidget = new About(this);
        QtHelper::centerWidget(aboutWidget);
        aboutWidget->show();
}
...
{
    QDesktopServices::openUrl(QUrl(DONATION_URL, QUrl::TolerantMode));
}
...
void MainWindow::buildFontsCache()
{
    ...
    {
        QDir folder;
        folder.mkpath(QStandardPaths::writableLocation(QStandardPaths::DataLocation));
    }
    ...
    QMap <QString,QString> mapGlobal  = QtHelper::exploreTTFDir(QtHelper::readPathsFontsValueIni(settings));
